    ...
    <div>
      <div className='flex items-start bg-[#F5F5F5]'>
          ...
          <div className="lg:w-[84%] w-full bg-[#F5F5F5] ml-auto">
              <TopNav />
              <div className="p-[10px] rounded-[8px] mt-5 lg:mx-[25px] lg:bg-[#FFFFFF] lg:border border-[#BDBDBD]">
                <div className='mt-5 ml-1'>
                  <p className='text-primary-color lg:text-[32px] text-[20px]'>Save {asset}</p>
                  <p className='font-[300] text-[#737985] lg:text-[14px] text-[12px]'>Choose your crypto and start earning daily interest today.<br />Rates may increase or decrease in the future. The change will be communicated in advance.</p>
                </div>
                <div className='pt-[3rem] pb-[9rem] flex justify-center items-center rounded-[11px] lg:mt-9 lg:bg-[#F1F1F1] flex-col'>
                          ...
                          <div className='grid grid-cols-2 sm:grid-cols-4 place-content-center place-items-center text-center gap-5 sm:gap-10 mb-4'>
                              {
                                  pricesArray.map((price, index) => (
                                      <p className='bg-[#F1F1F1] rounded-full py-[6px] px-7 w-full cursor-pointer' key={index}>${price}</p>
                                  ))
                              }
                          </div>
                  ...
                  <div className='bg-[#F8F8F8] py-6 px-[40px] rounded-[8px] shadow lg:w-[500px] w-full mt-[1.5rem] border border-[#B2B2B27A]'>
