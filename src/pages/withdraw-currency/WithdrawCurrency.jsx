        ...
        <div className='flex items-start bg-[#F5F5F5]'>
            ...
            <div className="w-full lg:w-[84%] bg-[#F5F5F5] ml-auto">
                ...
                <div className="p-[10px] rounded-[8px] mt-5 lg:mx-[25px] bg-transparent lg:bg-[#FFFFFF] border border-transparent lg:border-[#BDBDBD]">
                  ...
                  <div className='mt-9'>
                    <h2 className="text-center lg:text-[#151517] text-primary-color mb-2 font-[500] lg:font-[400]">Choose your withdrawal method</h2>
                    <div className='flex items-center gap-5'>
                        <div className="w-[500px] mx-auto lg:p-2 bg-[#F8F8F8] rounded-lg border border-[#B2B2B27A] responsive-widths">
                            ...
                            <div className='lg:flex items-center justify-center hidden'>
                              <button className='py-2 w-[90%] mx-auto text-white bg-primary-color rounded-[6px] mb-3 mt-[4rem]' onClick={() => navigate(`/withdraw-provider/${country}/provider`)} >Proceed</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='lg:hidden items-center justify-center flex mt-[5rem] w-[500px] mx-auto responsive-widths'>
                      <button className='py-2 w-full mx-auto text-white bg-primary-color rounded-[6px] mb-3 mt-[4rem]' onClick={() => navigate(`/withdraw-provider/${country}/provider`)} >Proceed</button>
                    </div>
                  </div>
                </div>
            </div>
